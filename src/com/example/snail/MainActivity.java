...
public class MainActivity extends Activity { 
  ...
  public void onCreate(Bundle savedInstanceState) {  
	  ...
	  setContentView(R.layout.guanka2);
	  //障碍物
      ...
      margin10.setMargins(270, 100, 0, 0);//在左边距400像素，顶边距10像素的位置显示图片
      ...
      margin11.setMargins(160, 200, 0, 0);//在左边距400像素，顶边距10像素的位置显示图片
			 ...
			 //
			  if (ballLp.topMargin>100&&ballLp.topMargin<130&&ballLp.leftMargin>50&&ballLp.leftMargin<80) {    
				  ...
				  ball.x=0;
					...
					ballLp.topMargin=0;
					ballLp.leftMargin=0;  
				  AlertDialog.Builder builder  = new Builder(com.example.snail.MainActivity.this);
			  ...
			  if (ballLp.topMargin>200&&ballLp.topMargin<230&&ballLp.leftMargin>160&&ballLp.leftMargin<190) {    
				  //new AlertDialog.Builder(com.example.snail.MainActivity.this).setTitle("删除提示框").setMessage("确认删除该数据？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
				  ball.x=0;
					ball.y=0;
					ballLp.topMargin=0;
			  ...
			  if (ballLp.topMargin>300&&ballLp.topMargin<330&&ballLp.leftMargin>50&&ballLp.leftMargin<80) {
				  ...
				  builder.setPositiveButton("确定", new DialogInterface.OnClickListener() { 
					  public void onClick(DialogInterface dialog, int which) { 
						  ...
						  //当选中是的时候，把这个activity关闭以防止重复打开相同的activity
