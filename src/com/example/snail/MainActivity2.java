	  ...
	  public void handleMessage(android.os.Message msg) {       
		  for (Activity2 ball : balls) {     
			  ...
			  if (ballLp.topMargin>100&&ballLp.topMargin<130&&ballLp.leftMargin>50&&ballLp.leftMargin<80) {    
				  ...
				  ball.x=0;
					...
					ballLp.topMargin=0;
					ballLp.leftMargin=0;  
				  AlertDialog.Builder builder  = new Builder(com.example.snail.MainActivity2.this);
					  ...
					  builder.setNegativeButton("取消", new DialogInterface.OnClickListener() { 
						  public void onClick(DialogInterface dialog, int which) { 
							  Intent intent=new Intent();
					        	intent.setClass(MainActivity2.this,MainPage.class);
					        	startActivity(intent);
							  //finish();
						  }
		...
		//退出窗口的间停事件
		  protected void dialog() { 
		        AlertDialog.Builder builder = new Builder(MainActivity2.this); 
