...
public class MainActivity1 extends Activity { 
  ...
  public void onCreate(Bundle savedInstanceState) {  
      ...
      margin10.setMargins(100, 100, 0, 0);//在左边距400像素，顶边距10像素的位置显示图片
      ...
      margin11.setMargins(150, 150, 0, 0);//在左边距400像素，顶边距10像素的位置显示图片
		  ...
		  for (Activity2 ball : balls) {     
			  ...
			  if (ballLp.topMargin>100&&ballLp.topMargin<130&&ballLp.leftMargin>270&&ballLp.leftMargin<300) {    
				  ...
				  ball.x=0;
					...
					ballLp.topMargin=0;
					ballLp.leftMargin=0;  
				  AlertDialog.Builder builder  = new Builder(com.example.snail.MainActivity1.this);
					  ...
					  builder.setNegativeButton("取消", new DialogInterface.OnClickListener() { 
						  public void onClick(DialogInterface dialog, int which) { 
							  Intent intent=new Intent();
					        	intent.setClass(MainActivity1.this,MainPage.class);
					        	startActivity(intent);
							  //finish();
						  }
